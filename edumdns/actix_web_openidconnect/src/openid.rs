...
use openidconnect::{reqwest, AdditionalClaims, Client, IdToken};
use openidconnect::{
...
pub struct AdditionalClaimsMuni {
    pub eduperson_entitlement: Option<Vec<String>>,
    pub eduperson_scoped_affiliation: Option<Vec<String>>,
}

impl AdditionalClaims for AdditionalClaimsMuni {}
...
impl OpenID {
    ...
    ) -> Result<UserInfoClaims<AdditionalClaimsMuni, CoreGenderClaim>> {
        Ok(self
            .client
