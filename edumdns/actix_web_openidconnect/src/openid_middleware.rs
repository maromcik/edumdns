...
use openidconnect::{AccessToken, AuthorizationCode, UserInfoClaims};
use serde::Deserialize;

use crate::openid::{AdditionalClaimsMuni, ExtendedIdToken, OpenID};
...
pub struct AuthenticatedUser {
    pub access: UserInfoClaims<AdditionalClaimsMuni, CoreGenderClaim>,
}
