...
pub async fn spawn_server_tasks(
    ...
    let data_channel = hotpath::channel!(tokio::sync::mpsc::channel(server_config.channel_buffer_capacity));
    let db_channel = hotpath::channel!(tokio::sync::mpsc::channel(server_config.channel_buffer_capacity));
